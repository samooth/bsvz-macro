...
pub const Scanner = struct {
    ...
    fn nextToken(self: *Scanner, allocator: std.mem.Allocator) LexError!TokenWithLoc {
        ...
        switch (c) {
            ...
            '(' => { self.advance(); return self.makeTok(.l_paren, start_line, start_col, start_offset, 1); },
            ')' => { self.advance(); return self.makeTok(.r_paren, start_line, start_col, start_offset, 1); },
